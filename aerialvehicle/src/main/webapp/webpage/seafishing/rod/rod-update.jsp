...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="rodController.do?doUpdate" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="name" name="name" type="text" style="width: 150px" class="inputxt"  value='${rodPage.name}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="detail" name="detail" type="text" style="width: 150px" class="inputxt"  value='${rodPage.detail}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="publishTime" name="publishTime" type="text" style="width: 150px" class="inputxt"  value='${rodPage.publishTime}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="pic" name="pic" type="text" style="width: 150px" class="inputxt"  value='${rodPage.pic}'>
							<span class="Validform_checktip"></span>
