...
<html>
 ...
 <body>
		<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="commentController.do?doUpdate" tiptype="1" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
					<tr>
						...
						<td class="value">
						     	 <input id="content" name="content" type="text" style="width: 150px" class="inputxt" datatype="*" value='${commentPage.content}'>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="commentTime" name="commentTime" type="text" style="width: 150px" class="inputxt"  value='${commentPage.commentTime}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="catchesId" name="catchesId" type="text" style="width: 150px" class="inputxt"  value='${commentPage.catchesId}'>
							<span class="Validform_checktip"></span>
					...
					<tr>
						...
						<td class="value">
						     	 <input id="customerId" name="customerId" type="text" style="width: 150px" class="inputxt"  value='${commentPage.customerId}'>
							<span class="Validform_checktip"></span>
